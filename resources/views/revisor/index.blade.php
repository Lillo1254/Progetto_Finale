        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center mb-5 gap-5">
                @foreach ($articles_to_check->take(4) as $article)
                                        ...
                                        <div class="row flex-wrap my-3 flex-grow-1"> 
                                            @foreach ($article->images as $key => $image)
                                                <div class="col-12 col-md mb-4 d-flex flex-column">
                                                    <div class="mb-3">
                                                        <img src="{{ $image->getUrl(1024, 1024) }}" alt="immagine {{ $key + 1 }} dell'articolo {{ $article->title }}" class="rounded-0 z-1 p-0 m-0 w-100">
                                                    </div>
                                                    <div class="image-details">
                                                        ...
                                                        <details>
                                                            <summary class="d-flex">
                                                                ...
                                                                <i class="bi bi-triangle-fill secondary-text" id="details"></i>
                                                            </summary>
                                                            <div class="labels-container d-flex flex-wrap gap-2 mb-3">
                                                                    @foreach ($image->labels as $label)
                                                                        <span class="badge bg-secondary p-2 rounded-pill label-pill">#{{ $label }}</span>
                                                                    @endforeach
                                                            </div>
                                                        </details>
                                                        @else
                                        ...
                                        <div class="row flex-wrap my-3 flex-grow-1">
                                            @for ($i = 0; $i < 2; $i++)
                                                <div class="col-6 col-sm-4 text-center d-flex flex-column">
                                                    <div class="mb-3">
                                                        <img src="/media/default.jpg" alt="Missing image" class="rounded-0 z-1 p-0 m-0 w-100">
                                                    </div>
                        ...
                        <div class="modal fade" id="declineModal-{{ $article->id }}" tabindex="-1" aria-labelledby="declineModalLabel-{{ $article->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content primary-light-bg">
                                    <div class="modal-header">
            ...
            <div class="row justify-content-center mt-3 mb-5 px-4 mx-1 gap-3">
                <a href="{{ route('revisor.articledecline') }}" class="btn col-12 col-sm-4 col-md-3 col-xl-2 btn-home rounded-5 ms-sm-3"">
                    <p class="m-auto p-0 px-1 dark-text">Lista articoli rifiutati</p>
                </a>
                <a href="{{ route('home') }}" class="btn col-12 mx-3 col-sm-4 col-md-3 col-xl-2 btn-home rounded-5 ms-sm-3">
