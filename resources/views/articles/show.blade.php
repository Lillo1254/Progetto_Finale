                        ...
                        <div id="articleCarousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://picsum.photos/300/301" class="d-block w-100"
                                        alt="Immagine articolo">
                                </div>
                                <div class="carousel-item active">
                                    <img src="https://picsum.photos/300/302" class="d-block w-100"
                                        alt="Immagine articolo">
                                </div>
                                <div class="carousel-item active">
                                    <img src="https://picsum.photos/300/303" class="d-block w-100"
                                        alt="Immagine articolo">
                                </div>
                            </div>
