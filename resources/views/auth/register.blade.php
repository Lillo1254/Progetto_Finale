                    ...
                    <form class="primary-light-bg-form p-5 rounded-0 form-glow mb-5" action="{{ route('register') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control rounded-0" id="password" name="password"
                                required
                                title="la password deve contenere almeno una lettera maiuscola, una minuscola, un numero e un simbolo speciale">
                            <ul class="ul-password list-unstyled mt-2">
                                <li id="uppercaseCheck" class="text-danger">❌ una lettera maiuscola</li>
                                <li id="lowercaseCheck" class="text-danger">❌ una minuscola</li>
                                <li id="numberCheck" class="text-danger">❌ un numero</li>
                                <li id="symbolCheck" class="text-danger">❌ un simbolo speciale @$!%*#?&</li>
                                <li id="minCheck" class="text-danger">❌ minimo 8 caratteri</li>
                            </ul>
                        </div>
                        <div class="mb-0">
                            <label for="password_confirmation"
                                class="form-label white-text">{{ __('ui.conferma_password') }}</label>
                        ...
                        <div
                            ...
                            <p class="my-0 mt-5 secondary-text">{{ __('ui.gia_account') }}<a
                                    class="form-link secondary-text text-decoration-none" href="{{ route('login') }}">
                                    Login</a></p>
                        </div>
